    ...
    <>
      <div className="topbar">
        <div className="topbar-inner">
          <span>{UI_TEXT.APP_PROMOTION}</span>
          <div>
        ...
        <div className="header-inner">
          ...
          <div className="cinema-picker-wrap">
            <button
              ...
              onClick={() => setCinemaMenuOpen((isOpen) => !isOpen)}
            >
              {cinema}
              <span>⌄</span>
            </button>
              ...
              <div className="cinema-menu">
                ...
                <div className="menu-col light">
                  {cinemas.map((cinemaName) => (
                    <button
                      key={cinemaName}
                      onClick={() => handleCinemaSelect(cinemaName)}
                    >
                      {cinemaName}
                    </button>
                  ))}
          ...
          <nav className="main-nav">
            {UI_TEXT.NAVIGATION.map(([pageKey, label]) => (
              <button
                key={pageKey}
